...
public class CoolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NEW", "CLASS", "INHERITS", "NOT", "IS_VOID", "SELF_TYPE", "LOWERCASE", 
			"UPPERCASE", "LETTER", "DIGIT", "TYPE", "ID", "INT", "BOOL", "STRING", 
			"SEMI", "COMMA", "DOT", "COLON", "QUOTATION", "ASSIGN", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "AT_SIGN", "TILDE", "PLUS", "MINUS", "MULT", "DIV", 
